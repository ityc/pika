...
const CyberCard = ({className, children, animation, hover}: Props) => {
    return (
        <div
            className={cn(
                "group bg-[#0f1016]/80 backdrop-blur-md border border-cyan-500/20 shadow-[0_0_15px_rgba(6,182,212,0.05)] transition-all duration-300 cursor-pointer overflow-hidden relative",
                hover && "hover:border-cyan-500/50 hover:shadow-[0_0_25px_rgba(6,182,212,0.15)] hover:bg-[#0f1016]/90"
            )}>
            {/* 装饰性边框 */}
            <div
